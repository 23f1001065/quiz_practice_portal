            ...
            <div class="p-5 border border-2 border-secondary rounded-1">
                ...
                <form v-on:submit.prevent="submitLogin">
                    <label>Email</label><br>
                        <input type="email" placeholder="email" v-model="email" class="form-control" autocomplete="username"><br>
                    <label>Password</label><br>
                        <input type="password" placeholder="password" v-model="password" class="form-control" autocomplete="current-password"><br>
